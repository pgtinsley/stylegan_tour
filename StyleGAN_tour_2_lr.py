...
dirnames = os.listdir('../data_100/lr/results_EMPTYDIRS/') # CRC -- lower res images
...
#     vec = np.load('./data/FRGC/FRGC-2.0-dist/nd1/custom_100/' + dirname + '/' + dirname + '_01.npy') # CRC high res
    vec = np.load('../data_100/lr/latent_representations/' + dirname + '_01.npy') # CRC lower res images
    for a in range(18):
#         pkl_fname2 = './data/FRGC/FRGC-2.0-dist/nd1/custom_100/' + dirname + '/' + dirname + '_axis' + str(a) + '.pkl' # CRC high res
        pkl_fname2 = '../data_100/lr/results_EMPTYDIRS/' + dirname + '/' + dirname + '_axis' + str(a) + '.pkl' # CRC lower res images
